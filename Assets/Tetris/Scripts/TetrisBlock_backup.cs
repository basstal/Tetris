...
// {
//     [NonSerialized] public TetrisShape belongsTo;
//     [NonSerialized] public bool toBeDelete;
// #if DEBUG
//     public Vector3 cachedPos;
// #endif
//     [ClientRpc]
//     public void InitClientRpc(int index, Vector2 pos)
//     {
//         // Debug.LogWarning($"run here index : {index}");
...
// #endif
//         belongsTo = transform.parent.GetComponent<TetrisShape>();
//         belongsTo.blocks.Add(this);
//         var display = Instantiate(Settings.Instance.shapes[index].basic, transform, false);
